 ...
 * - 100% Offline: No external CDN dependencies (v3.4.3)
 */
        ...
        devices.forEach(function(d) {
            ...
            if (isExternal) {
                ...
                if (hasLocation && hasRack) {
                    ...
                    var extLabel = hasLocation ? d.location : (hasRack ? d.rackId : 'External');
...
var DrawioExport = (function() {
    ...
    function exportDrawio() {
        ...
        devices.forEach(function(d, idx) {
            ...
            devicePositions[d.id] = { x: x + 40, y: y + 30, id: cellId };
    ...
    function getDrawioStyle(type) {
        // Using standard shapes that are always available in Draw.io
        // These provide good visual representation without requiring external libraries
        var styles = {
            router: 'rounded=1;whiteSpace=wrap;html=1;fillColor=#036897;strokeColor=#001933;fontColor=#ffffff;arcSize=20;',
            switch: 'shape=trapezoid;perimeter=trapezoidPerimeter;whiteSpace=wrap;html=1;fixedSize=1;fillColor=#29A352;strokeColor=#0D5E1C;fontColor=#ffffff;',
            patch: 'shape=process;whiteSpace=wrap;html=1;backgroundOutline=1;fillColor=#EAB308;strokeColor=#9A6700;fontColor=#000000;',
            firewall: 'shape=mxgraph.basic.layered_rect;dx=10;whiteSpace=wrap;html=1;fillColor=#EF4444;strokeColor=#990000;fontColor=#ffffff;',
            server: 'shape=cylinder3;whiteSpace=wrap;html=1;boundedLbl=1;backgroundOutline=1;size=15;fillColor=#8B5CF6;strokeColor=#5A287D;fontColor=#ffffff;',
            wifi: 'ellipse;shape=cloud;whiteSpace=wrap;html=1;fillColor=#06B6D4;strokeColor=#0077B3;fontColor=#ffffff;',
            isp: 'ellipse;shape=cloud;whiteSpace=wrap;html=1;fillColor=#F97316;strokeColor=#C75000;fontColor=#ffffff;',
            router_wifi: 'rounded=1;whiteSpace=wrap;html=1;fillColor=#0EA5E9;strokeColor=#0066AA;fontColor=#ffffff;arcSize=30;',
            nas: 'shape=cylinder3;whiteSpace=wrap;html=1;boundedLbl=1;backgroundOutline=1;size=15;fillColor=#6366f1;strokeColor=#3730a3;fontColor=#ffffff;',
            storage: 'shape=cylinder3;whiteSpace=wrap;html=1;boundedLbl=1;backgroundOutline=1;size=15;fillColor=#10b981;strokeColor=#047857;fontColor=#ffffff;',
            phone: 'shape=parallelogram;perimeter=parallelogramPerimeter;whiteSpace=wrap;html=1;fixedSize=1;size=20;fillColor=#f472b6;strokeColor=#be185d;fontColor=#ffffff;',
            camera: 'ellipse;whiteSpace=wrap;html=1;fillColor=#f59e0b;strokeColor=#b45309;fontColor=#ffffff;',
            laptop: 'shape=document;whiteSpace=wrap;html=1;boundedLbl=1;fillColor=#2d3436;strokeColor=#000000;fontColor=#ffffff;',
            desktop: 'shape=process;whiteSpace=wrap;html=1;backgroundOutline=1;fillColor=#6c5ce7;strokeColor=#4c3d9e;fontColor=#ffffff;',
            printer: 'shape=card;whiteSpace=wrap;html=1;fillColor=#a0aec0;strokeColor=#718096;fontColor=#000000;',
            ups: 'shape=step;perimeter=stepPerimeter;whiteSpace=wrap;html=1;fixedSize=1;size=10;fillColor=#fbbf24;strokeColor=#d97706;fontColor=#000000;',
            modem: 'rounded=1;whiteSpace=wrap;html=1;fillColor=#14b8a6;strokeColor=#0d9488;fontColor=#ffffff;',
            others: 'rounded=1;whiteSpace=wrap;html=1;fillColor=#64748B;strokeColor=#334155;fontColor=#ffffff;'
        };
