...
function updateDevicesListTable(cont) {
    ...
    html += '<th class="p-2 text-left cursor-pointer hover:bg-slate-600 whitespace-nowrap uppercase" onclick="toggleDeviceSort(\'location\')">Location ' + sortIcon('location') + '</th>';
    html += '<th class="p-2 text-left cursor-pointer hover:bg-slate-600 whitespace-nowrap uppercase" onclick="toggleDeviceSort(\'rack\')">Group ' + sortIcon('rack') + '</th>';
    html += '<th class="p-2 text-center cursor-pointer hover:bg-slate-600 whitespace-nowrap uppercase" onclick="toggleDeviceSort(\'order\')">Pos ' + sortIcon('order') + '</th>';
    html += '<th class="p-2 text-left cursor-pointer hover:bg-slate-600 whitespace-nowrap uppercase" onclick="toggleDeviceSort(\'name\')">Device ' + sortIcon('name') + '</th>';
    html += '<th class="p-2 text-left cursor-pointer hover:bg-slate-600 whitespace-nowrap uppercase" onclick="toggleDeviceSort(\'brandModel\')">Brand/Model ' + sortIcon('brandModel') + '</th>';
    html += '<th class="p-2 text-left cursor-pointer hover:bg-slate-600 whitespace-nowrap uppercase" onclick="toggleDeviceSort(\'type\')">Type ' + sortIcon('type') + '</th>';
    html += '<th class="p-2 text-center cursor-pointer hover:bg-slate-600 whitespace-nowrap uppercase" onclick="toggleDeviceSort(\'status\')">Status ' + sortIcon('status') + '</th>';
