...
var SVGTopology = (function() {
    ...
    var deviceIcons = {
        ...
        wlc: function(color) {
            return '<g transform="translate(10,5) scale(0.85)">' +
                // Tower base
                '<rect x="25" y="45" width="50" height="15" rx="2" fill="#2d3436"/>' +
                '<rect x="27" y="47" width="46" height="11" fill="#1e272e" rx="1"/>' +
                // Main antenna
                '<line x1="50" y1="45" x2="50" y2="10" stroke="#636e72" stroke-width="3" stroke-linecap="round"/>' +
                '<circle cx="50" cy="8" r="4" fill="#0984e3" stroke="#0984e3" stroke-width="1"/>' +
                // Secondary antenna 1
                '<line x1="35" y1="35" x2="25" y2="18" stroke="#636e72" stroke-width="2.5" stroke-linecap="round"/>' +
                '<circle cx="24" cy="16" r="3" fill="#0984e3" stroke="#0984e3" stroke-width="1"/>' +
                // Secondary antenna 2
                '<line x1="65" y1="35" x2="75" y2="18" stroke="#636e72" stroke-width="2.5" stroke-linecap="round"/>' +
                '<circle cx="76" cy="16" r="3" fill="#0984e3" stroke="#0984e3" stroke-width="1"/>' +
                // Signal waves
                '<circle cx="50" cy="30" r="8" fill="none" stroke="#0984e3" stroke-width="1" opacity="0.6"/>' +
                '<circle cx="50" cy="30" r="12" fill="none" stroke="#0984e3" stroke-width="0.8" opacity="0.4"/>' +
                '</g>';
        },
        // Digital Video Recorder (DVR)
        dvr: function(color) {
            return '<g transform="translate(5,10) scale(0.85)">' +
                // Chassis
                '<rect x="5" y="10" width="80" height="40" rx="3" fill="#2d3436"/>' +
                '<rect x="8" y="13" width="74" height="36" rx="2" fill="#1e272e"/>' +
                // Screen area (top)
                '<rect x="12" y="16" width="66" height="16" fill="#0c0c0c" rx="1"/>' +
                '<rect x="14" y="18" width="62" height="12" fill="#1a5f1a"/> <!-- Green recording -->' +
                '<text x="45" y="26" text-anchor="middle" fill="#00b894" font-size="6" font-weight="bold">REC</text>' +
                // Drive bays (bottom)
                '<rect x="12" y="36" width="15" height="10" fill="#0c0c0c" stroke="#636e72" stroke-width="0.5" rx="1"/>' +
                '<rect x="30" y="36" width="15" height="10" fill="#0c0c0c" stroke="#636e72" stroke-width="0.5" rx="1"/>' +
                '<rect x="48" y="36" width="15" height="10" fill="#0c0c0c" stroke="#636e72" stroke-width="0.5" rx="1"/>' +
                '<rect x="66" y="36" width="10" height="10" fill="#0c0c0c" stroke="#636e72" stroke-width="0.5" rx="1"/>' +
                '</g>';
        },
        // Power over Ethernet (PoE)
        poe: function(color) {
            return '<g transform="translate(15,8) scale(0.85)">' +
                // Injection point (circular node)
                '<circle cx="30" cy="30" r="12" fill="#f39c12" stroke="#e67e22" stroke-width="2"/>' +
                '<circle cx="30" cy="30" r="8" fill="#fdcb6e"/>' +
                '<text x="30" y="33" text-anchor="middle" fill="#2d3436" font-size="7" font-weight="bold">⚡</text>' +
                // Network cable line (left)
                '<line x1="12" y1="30" x2="18" y2="30" stroke="#b2bec3" stroke-width="3" stroke-linecap="round"/>' +
                '<circle cx="15" cy="30" r="2" fill="#0984e3"/>' +
                // Power delivery line (right)
                '<line x1="42" y1="30" x2="52" y2="30" stroke="#e74c3c" stroke-width="3" stroke-linecap="round"/>' +
                '<circle cx="48" cy="30" r="2" fill="#e74c3c"/>' +
                // Power indicator
                '<circle cx="48" cy="25" r="3" fill="#e74c3c" opacity="0.8"/>' +
                // Data flow
                '<path d="M20,20 Q30,10 40,20" fill="none" stroke="#0984e3" stroke-width="2" stroke-dasharray="3,2"/>' +
                '</g>';
        },
        // IoT Device
        iot: function(color) {
            return '<g transform="translate(12,8) scale(0.85)">' +
                // Body - rounded square (tech device)
                '<rect x="15" y="15" width="50" height="40" rx="8" fill="#2d3436"/>' +
                '<rect x="18" y="18" width="44" height="34" rx="6" fill="#1e272e"/>' +
                // Screen/Display
                '<rect x="22" y="22" width="36" height="12" fill="#0c0c0c" rx="2"/>' +
                '<circle cx="25" cy="28" r="2" fill="#00b894"/>' +
                '<circle cx="28" cy="28" r="2" fill="#0984e3"/>' +
                '<circle cx="31" cy="28" r="2" fill="#fdcb6e"/>' +
                // Sensor ports
                '<rect x="22" y="37" width="8" height="8" fill="#0c0c0c" rx="1"/>' +
                '<rect x="33" y="37" width="8" height="8" fill="#0c0c0c" rx="1"/>' +
                '<rect x="44" y="37" width="8" height="8" fill="#0c0c0c" rx="1"/>' +
                // WiFi indicator
                '<path d="M60,20 Q65,15 70,20" fill="none" stroke="#0984e3" stroke-width="1.5"/>' +
                '<path d="M60,24 Q70,13 80,24" fill="none" stroke="#0984e3" stroke-width="1.5" opacity="0.6"/>' +
                '</g>';
        },
        // Test/Lab Device (TST)
        tst: function(color) {
            return '<g transform="translate(10,5) scale(0.85)">' +
                // Test tube shape
                '<path d="M25,15 L20,35 Q20,50 30,50 Q40,50 40,35 L35,15 Z" fill="none" stroke="#9b59b6" stroke-width="2"/>' +
                '<rect x="18" y="10" width="24" height="6" fill="#9b59b6" rx="1"/>' +
                // Liquid inside (test result)
                '<path d="M22,38 Q22,48 30,48 Q38,48 38,38 Z" fill="#e74c3c" opacity="0.7"/>' +
                // Measurement marks
                '<line x1="16" y1="25" x2="44" y2="25" stroke="#9b59b6" stroke-width="1" opacity="0.5"/>' +
                '<line x1="16" y1="32" x2="44" y2="32" stroke="#9b59b6" stroke-width="1" opacity="0.5"/>' +
                '<line x1="16" y1="39" x2="44" y2="39" stroke="#9b59b6" stroke-width="1" opacity="0.5"/>' +
                // Beaker beside
                '<path d="M55,20 L52,45 Q52,50 58,50 Q64,50 64,45 L61,20 Z" fill="none" stroke="#3498db" stroke-width="2"/>' +
                '<rect x="52" y="18" width="12" height="4" fill="#3498db" rx="0.5"/>' +
                // Liquid in beaker
                '<path d="M54,38 Q54,48 58,48 Q62,48 62,38 Z" fill="#00b894" opacity="0.7"/>' +
                '</g>';
        },
        ...
        // Wall Jack Telephone / Presa Telefono RJ11
        walljack_tel: function(color) {
            return '<g transform="translate(15,5) scale(0.85)">' +
                // Wall plate
                '<rect x="5" y="5" width="55" height="60" rx="3" fill="#fef3c7" stroke="#d97706" stroke-width="2"/>' +
                // Inner frame
                '<rect x="10" y="10" width="45" height="50" rx="2" fill="#fde68a"/>' +
                // RJ11 port upper (smaller than RJ45)
                '<rect x="20" y="15" width="24" height="16" rx="2" fill="#2d3436"/>' +
                '<rect x="23" y="18" width="18" height="10" fill="#0c0c0c" rx="1"/>' +
                // RJ11 pins (4 pins instead of 8)
                '<rect x="25" y="20" width="2" height="5" fill="#c0a000"/>' +
                '<rect x="29" y="20" width="2" height="5" fill="#c0a000"/>' +
                '<rect x="33" y="20" width="2" height="5" fill="#c0a000"/>' +
                '<rect x="37" y="20" width="2" height="5" fill="#c0a000"/>' +
                // Label TEL
                '<text x="33" y="36" text-anchor="middle" fill="#92400e" font-size="5" font-weight="bold" font-family="sans-serif">TEL</text>' +
                // RJ11 port lower
                '<rect x="20" y="42" width="24" height="16" rx="2" fill="#2d3436"/>' +
                '<rect x="23" y="45" width="18" height="10" fill="#0c0c0c" rx="1"/>' +
                // RJ11 pins lower
                '<rect x="25" y="47" width="2" height="5" fill="#c0a000"/>' +
                '<rect x="29" y="47" width="2" height="5" fill="#c0a000"/>' +
                '<rect x="33" y="47" width="2" height="5" fill="#c0a000"/>' +
                '<rect x="37" y="47" width="2" height="5" fill="#c0a000"/>' +
                // Decorative screws
                '<circle cx="12" cy="12" r="2" fill="#b45309"/>' +
                '<circle cx="53" cy="12" r="2" fill="#b45309"/>' +
                '<circle cx="12" cy="58" r="2" fill="#b45309"/>' +
                '<circle cx="53" cy="58" r="2" fill="#b45309"/>' +
                '</g>';
        },
    ...
    // Abbreviations for device types (for topology display)
    ...
    var typeColors = {
        ...
        wifi: '#636e72',        // Gray (AP)
        wlc: '#1e272e',         // Black (wireless controller)
        ...
        dvr: '#2d3436',         // Dark gray (video recorder)
        nas: '#2d3436',         // Dark gray (storage)
        ups: '#2d3436',         // Dark gray (power)
        poe: '#1e272e',         // Black (PoE injector)
        iot: '#636e72',         // Gray (IoT)
        tst: '#7f8c8d',         // Gray (test bench)
        walljack: '#ecf0f1',    // Light gray (wall plate)
        walljack_tel: '#fef3c7', // Light yellow (telephone wall plate)
    ...
    // Labels for device types (Italian for UI)
    var typeLabels = {
        router: 'Router',
        switch: 'Switch',
        patch: 'Patch Panel',
        ...
        dvr: 'DVR/NVR',
        nas: 'NAS/Archiviazione',
        ups: 'UPS',
        poe: 'PoE Injector/Switch',
        iot: 'Dispositivo IoT',
        tst: 'Bancada Test',
        walljack: 'Presa a Muro (RJ45)',
        walljack_tel: 'Presa Telefono (RJ11)',
        modem: 'Modem',
        external: 'Esterno',
        tv: 'TV/Display',
        display: 'Display',
    ...
    function calculatePositions(devices, layout) {
        // Dynamic dimensions based on device count (Content-First approach)
        var deviceCount = devices.length || 1;
        var baseWidth = 1200;
        var baseHeight = 600;
        var width = Math.max(baseWidth, deviceCount * 120);
        var height = Math.max(baseHeight, deviceCount * 60);
        var nodeWidth = 80;
        var nodeHeight = 70;
        var padding = 120;
        ...
        if (layout === 'circle') {
            // Dynamic radius based on device count for proper spacing
            var radius = Math.max(300, deviceCount * 25);
            // Center dynamically based on calculated radius
            var centerX = radius + padding;
            var centerY = radius + padding;
            ...
            var typeOrder = [
                ...
                'patch', 'walljack', 'walljack_tel', 'wifi',       // Layer 5: Access
            ...
            typeOrder.forEach(function(type) {
                if (byType[type] && byType[type].length > 0) {
                    ...
                    // Dynamic startX - start from padding, no fixed center constraint
                    var startX = padding;
    ...
    function buildSVG(devices, connections) {
        ...
        connections.forEach(function(c) {
            ...
            var wjType = c.wallJackType || 'rj45';
            var wjKey = c.externalDest + '_' + wjType;
            if (!wallJackMap[wjKey]) {
                ...
                var hashCode = 0;
                var hashStr = c.from + '-' + c.externalDest + '-' + wjType + '-' + c.fromPort;
                ...
                var virtualDevice = {
                    id: virtualId,
                    name: c.externalDest,
                    type: wjType === 'rj11' ? 'walljack_tel' : 'walljack',
                    wallJackType: wjType,
        ...
        function getConnectionDot(deviceId, connIdx, totalConns, deviceX, deviceY, targetX, targetY) {
            ...
            // Device radius - increased to 58 to clear icons and text
            var radius = 58;
        ...
        connections.forEach(function(c) {
            ...
            var cableId = c.cableMarker || '';
            var wjType = c.wallJackType || 'rj45';
            var wjLookupKey = externalDest + '_' + wjType;
            
            var fromKey = 'from-' + externalDest + '_' + wjType;
            var fromIdx = deviceConnectionIndex[c.from][fromKey] || 0;
            var fromTotal = deviceConnectionCount[c.from] || 1;
            
            // Wall Jack connections
            if (isWallJack && wallJackMap[wjLookupKey]) {
                var virtualId = wallJackMap[wjLookupKey].id;
        ...
        virtualExternals.forEach(function(ext) {
            ...
            // External name with type abbreviation in purple
            var name = ext.name || 'External';
            var extAbbr = typeAbbreviations[ext.type] || '?';
            html += '<text x="40" y="72" text-anchor="middle" fill="#8b5cf6" font-size="7" font-weight="700" ' +
                'style="paint-order: stroke; stroke: white; stroke-width: 2px; letter-spacing: 0.5px;">' + extAbbr + '</text>';
            html += '<text x="40" y="82" text-anchor="middle" fill="#1e293b" font-size="9" font-weight="600" ' +
        ...
        devices.forEach(function(d) {
            ...
            // Device name - with type abbreviation in purple
            var name = getDeviceDisplayName(d) || 'Unnamed';
            var devType = d.type || 'others';
            var devAbbr = typeAbbreviations[devType] || '?';
            html += '<text x="40" y="72" text-anchor="middle" fill="#8b5cf6" font-size="7" font-weight="700" ' +
                'style="paint-order: stroke; stroke: white; stroke-width: 2px; letter-spacing: 0.5px;">' + devAbbr + '</text>';
            html += '<text x="40" y="82" text-anchor="middle" fill="#1e293b" font-size="9" font-weight="600" ' +
                'style="paint-order: stroke; stroke: white; stroke-width: 3px;">' + escapeHtml(name) + '</text>';
        ...
        if (virtualWallJacks.length > 0) {
            ...
            virtualWallJacks.forEach(function(wj) {
                ...
                var wjDevType = wj.type || 'walljack';
                var color = typeColors[wjDevType] || typeColors.walljack || '#ecf0f1';
                var iconFn = deviceIcons[wjDevType] || deviceIcons.walljack;
                var typeLabel = wj.wallJackType === 'rj11' ? 'WALL JACK (RJ11)' : 'WALL JACK (RJ45)';
                ...
                // Wall Jack name with type abbreviation in purple
                var name = wj.name || 'Wall Jack';
                var wjAbbr = wj.wallJackType === 'rj11' ? 'RJ11' : 'RJ45';
                html += '<text x="40" y="72" text-anchor="middle" fill="#8b5cf6" font-size="7" font-weight="700" ' +
                    'style="paint-order: stroke; stroke: white; stroke-width: 2px; letter-spacing: 0.5px;">' + wjAbbr + '</text>';
                html += '<text x="40" y="82" text-anchor="middle" fill="#1e293b" font-size="9" font-weight="600" ' +
                    'style="paint-order: stroke; stroke: white; stroke-width: 3px;">' + escapeHtml(name) + '</text>';
    ...
    function drag(e) {
        ...
        // Protect against zero-size rect (can happen during layout shifts)
        if (!svgRect || svgRect.width <= 0 || svgRect.height <= 0) return;
        ...
        if (clientX < svgRect.left - margin || clientX > svgRect.right + margin ||
            ...
            // Mouse is too far outside - don't update position to prevent visual glitches
            return;
        }
    ...
    function updateConnections() {
        ...
        connections.forEach(function(c) {
            ...
            var fromKey = 'from-' + wjLookupKey;
            var fromIdx = deviceConnectionIndex[c.from][fromKey] || 0;
            var fromTotal = deviceConnectionCount[c.from] || 1;
            
            if (isWallJack) {
                var virtualId = 'wj_' + wjLookupKey.replace(/[^a-zA-Z0-9]/g, '_');
                var wjPos = devicePositions[virtualId];
                if (wjPos) {
                    var wjCX = wjPos.x + 40;
                    var wjCY = wjPos.y + 35;
    ...
    function handleZoom(e) {
        ...
        var newWidth = viewBox.width * delta;
        var newHeight = viewBox.height * delta;
        
        // Prevent zooming out too far (max 50000) or in too far (min 100)
    ...
    if (typeof appState !== 'undefined' && appState.connections) {
        ...
        for (var w = 0; w < appState.connections.length; w++) {
            ...
            if (conn.isWallJack && conn.externalDest) {
                var wjCountKey = conn.externalDest + '_' + (conn.wallJackType || 'rj45');
                wallJackSet[wjCountKey] = true;
            }
        }
...
var DrawioExport = (function() {
        ...
        connections.forEach(function(c) {
            if (c.from && c.to && devicePositions[c.from] && devicePositions[c.to]) {
                ...
                cellsXml += '<mxCell id="' + cellId + '" value="' + escapeXml(label) + '" ' +
                    ...
                    '</mxCell>';
                cellId++;
            } else if (c.from && !c.to && devicePositions[c.from] && (c.isWallJack || c.externalDest)) {
                // WallJack or External connections — add a label node as target
                var wjTypeStr = c.wallJackType === 'rj11' ? ' RJ11' : ' RJ45';
                var extLabel = c.isWallJack ? '[WJ' + wjTypeStr + '] ' + (c.externalDest || 'Wall Jack') : '[EXT] ' + (c.externalDest || 'External');
                var srcPos = devicePositions[c.from];
                var extX = srcPos.x + 250;
                var extY = srcPos.y;
                var extStyle = c.isWallJack
                    ? (c.wallJackType === 'rj11'
                        ? 'shape=mxgraph.floorplan.wall.wallU;fillColor=#fef3c7;strokeColor=#d97706;fontStyle=1;fontSize=10;'
                        : 'shape=mxgraph.floorplan.wall.wallU;fillColor=#fff2cc;strokeColor=#d6b656;fontStyle=1;fontSize=10;')
                    : 'shape=mxgraph.networks.cloud;fillColor=#dae8fc;strokeColor=#6c8ebf;fontStyle=1;fontSize=10;';

                cellsXml += '<mxCell id="' + cellId + '" value="' + escapeXml(extLabel) + '" ' +
                    'style="' + extStyle + '" vertex="1" parent="1">' +
                    '<mxGeometry x="' + extX + '" y="' + extY + '" width="120" height="40" as="geometry"/>' +
                    '</mxCell>';
                var extNodeId = cellId;
                cellId++;

                var color2 = config.connColors[c.type] || '#6b7280';
                var label2 = c.cableMarker || '';
                var edgeStyle2 = 'edgeStyle=orthogonalEdgeStyle;rounded=1;orthogonalLoop=1;jettySize=auto;html=1;' +
                    'strokeColor=' + color2 + ';strokeWidth=2;';
                if (c.status === 'disabled') {
                    edgeStyle2 += 'dashed=1;';
                }
                cellsXml += '<mxCell id="' + cellId + '" value="' + escapeXml(label2) + '" ' +
                    'style="' + edgeStyle2 + '" edge="1" parent="1" source="' + srcPos.id + '" target="' + extNodeId + '">' +
                    '<mxGeometry relative="1" as="geometry"/>' +
                    '</mxCell>';
                cellId++;
            }
    ...
    function getDrawioStyle(type) {
        ...
        var styles = {
            ...
            walljack_tel: 'shape=mxgraph.cisco.misc.connector;html=1;pointerEvents=1;dashed=0;fillColor=#fbbf24;strokeColor=#d97706;strokeWidth=2;verticalLabelPosition=bottom;verticalAlign=top;',
...
var DeviceLinks = (function() {
    ...
    function addField(containerId) {
        ...
        div.innerHTML = 
            '<select class="link-type px-1 py-1 border border-slate-300 rounded text-xs">' +
            linkTypes.map(function(t) {
                return '<option value="' + t.value + '">' + t.icon + ' ' + t.label + '</option>';
            }).join('') +
            '</select>' +
            '<input type="text" class="link-url flex-1 px-2 py-1 border border-slate-300 rounded text-xs font-mono" placeholder="10.10.0.1 o URL">' +
            '<button type="button" onclick="this.parentElement.remove()" class="text-red-500 hover:text-red-700 px-1 text-xs">✕</button>';
    ...
    function renderLinks(links, deviceId) {
        ...
        return links.map(function(link, idx) {
            ...
            // HTTP/HTTPS/FTP — abrem direto no navegador (icone clicável)
            if (link.url.match(/^(https?|ftp):\/\//i) || link.url.match(/^\\\\/) || link.url.match(/^\//)) {
                return '<a href="' + safeUrl + '" target="_blank" class="inline-flex items-center text-sm text-blue-600 hover:text-blue-800" title="' + typeInfo.label + ': ' + safeUrl + '">' +
                    typeInfo.icon + '</a>';
            }
            
            // SSH, RDP, VNC, Telnet, SMB, NFS — via Guacamole (icone clicável)
            if (link.url.match(/^(ssh|rdp|vnc|smb|nfs|telnet):\/\//i) || link.type === 'ssh' || link.type === 'rdp' || link.type === 'vnc' || link.type === 'smb' || link.type === 'telnet' || link.type === 'nfs') {
                ...
                return '<a href="javascript:void(0)" data-protocol="' + protocolType + '" data-url="' + safeUrl + '"' + deviceIdAttr + ' onclick="openProtocolLink(this)" class="inline-flex items-center text-sm text-blue-600 hover:text-blue-800 cursor-pointer" title="' + typeInfo.label + ' via Guacamole: ' + safeUrl + '">' +
                    typeInfo.icon + '</a>';
            }
            
            // Outros — icone genérico
            return '<a href="' + safeUrl + '" target="_blank" class="inline-flex items-center text-sm text-slate-600" title="' + safeUrl + '">' +
                typeInfo.icon + '</a>';
        }).join(' ');
    }
...
function generateDevicesPrintContent(location) {
    ...
    devices.forEach(function(d) {
        ...
        html += '<td>' + (getDeviceDisplayName(d) || '-') + '</td>';
        html += '<td>' + (d.type || '-') + '</td>';
...
function generateConnectionsPrintContent(location) {
    ...
    connections.forEach(function(c) {
        ...
        html += '<td>' + (fromDev ? getDeviceDisplayName(fromDev) : 'Unknown') + '</td>';
        html += '<td>' + (c.fromPort || '-') + '</td>';
        html += '<td>' + (toDev ? getDeviceDisplayName(toDev) : c.externalDest || 'Unknown') + '</td>';
        html += '<td>' + (c.toPort || '-') + '</td>';
        html += '<td>' + (c.type || '-') + '</td>';
