...
var SVGTopology = (function() {
    ...
    function buildSVG(devices, connections) {
        ...
        devices.forEach(function(d) {
            if (d.name) {
                existingDeviceNames[d.name.toLowerCase()] = d.id;
            }
        });
        ...
        connections.forEach(function(c) {
            ...
            // Skip if a real device with this name already exists
            if (existingDeviceNames[extKey.toLowerCase()]) {
                return;
            }
        ...
        connections.forEach(function(c) {
            ...
            // Non-Wall Jack external: check if there's a real device with this name first
            var realDeviceId = existingDeviceNames[externalDest.toLowerCase()];
